   ...
   <div class="card shadow">
            <div class="card-header border-0">
              <div class="row align-items-center">
                <div class="col">
                  <h3 class="mb-0"><i class="ni ni-cloud-download-95"> Cita N.</i> {{$appointment->id}}</h3>
                </div>
                </div>
        ...
        <div class="card-body">
            <ul>
                <li>
                  <strong>Fecha: </strong> {{ $appointment->scheluded_date}}
                </li>
                 <li>
                  <strong>Hora: </strong> {{ $appointment->scheluded_time_12}}
                </li>
        ...
        @endif
          ...
          <a href="{{ url('/appointments')}}" class="btn btn-default"><i class="ni ni-bold-left">Volver</i>
          </a>
        </div>
         </div>  
